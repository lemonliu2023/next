import{j as d}from"./index-_74sN05i.js";import{P as g,S as w,d as T,D as M,c as P,G as z,T as R,u as D}from"./useInitAll-BZnQvJx1.js";const U=`
...
varying vec2 v_position;
    ...
    }`};function C(l,t){const{radius:r=50,color:i="#00FF00",speed:j=1,opacity:b=1,angle:I=Math.PI,position:v={x:0,y:0,z:0},rotation:e={x:-Math.PI/2,y:0,z:0}}={},a=50*2,F=u=>{const s=new R().load("/next/public/"+u),m=`
      varying vec2 vUv;
      void main() {
        vUv = uv;
        gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
