import{r as h,Y as o}from"./index-D3khomyw.js";import{S as T,D as u,P as y,M as U,V as W,u as x}from"./useInitAll-CbSIb_cJ.js";const C=`
    varying vec2 vUv;
    void main() {
        vUv = uv;
...
}`,w=i=>{const{lineWidth:t,height:e,width:l,position:s,lineOpenTime:m,scanTime:v,opacityTime:c}=Object.assign({lineWidth:1,height:100,width:100,position:[0,0,0],lineOpenTime:.8,scanTime:2,opacityTime:.2},i),r=new T({uniforms:{time:{value:0},lineWidth:{value:t/e},lineOpenTime:{value:m},scanTime:{value:v},opacityTime:{value:c}},vertexShader:C,fragmentShader:j,transparent:!0,side:u}),d=new y(l,e,1e3,1e3),n=new U(d,r);n.position.copy(new W(...s));const p=performance.now();function a(){const g=performance.now();requestAnimationFrame(a);const f=(g-p)/1e3;r.uniforms.time.value=f}return a(),n},_=()=>{const{sceneRef:i,rendererRef:t}=x("threejs-examples");return h.useEffect(()=>{var e;(e=i.current)==null||e.add(w())},[t,i]),o.jsx(o.Fragment,{children:o.jsx("div",{className:"threejs-examples-main",children:o.jsx("div",{id:"threejs-examples"})})})};export{_ as default};
