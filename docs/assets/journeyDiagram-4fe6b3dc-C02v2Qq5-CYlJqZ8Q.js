...
`,At=Et,q=function(t,e){return kt(t,e)},jt=function(t,e){const s=t.append("circle").attr("cx",e.cx).attr("cy",e.cy).attr("class","face").attr("r",15).attr("stroke-width",2).attr("overflow","visible"),o=t.append("g");o.append("circle").attr("cx",e.cx-15/3).attr("cy",e.cy-15/3).attr("r",1.5).attr("stroke-width",2).attr("fill","#666").attr("stroke","#666"),o.append("circle").attr("cx",e.cx+15/3).attr("cy",e.cy-15/3).attr("r",1.5).attr("stroke-width",2).attr("fill","#666").attr("stroke","#666");function n(y){const p=J().startAngle(Math.PI/2).endAngle(3*(Math.PI/2)).innerRadius(7.5).outerRadius(6.8181818181818175);y.append("path").attr("class","mouth").attr("d",p).attr("transform","translate("+e.cx+","+(e.cy+2)+")")}function h(y){const p=J().startAngle(3*Math.PI/2).endAngle(5*(Math.PI/2)).innerRadius(7.5).outerRadius(6.8181818181818175);y.append("path").attr("class","mouth").attr("d",p).attr("transform","translate("+e.cx+","+(e.cy+7)+")")}function l(y){y.append("line").attr("class","mouth").attr("stroke",2).attr("x1",e.cx-5).attr("y1",e.cy+7).attr("x2",e.cx+5).attr("y2",e.cy+7).attr("class","mouth").attr("stroke-width","1px").attr("stroke","#666")}return e.score>3?n(o):e.score<3?h(o):l(o),s},st=function(t,e){const s=t.append("circle");return s.attr("cx",e.cx),s.attr("cy",e.cy),s.attr("class","actor-"+e.pos),s.attr("fill",e.fill),s.attr("stroke",e.stroke),s.attr("r",e.r),s.class!==void 0&&s.attr("class",s.class),e.title!==void 0&&s.append("title").text(e.title),s},rt=function(t,e){return _t(t,e)},Vt=function(t,e){function s(n,h,l,y,p){return n+","+h+" "+(n+l)+","+h+" "+(n+l)+","+(h+y-p)+" "+(n+l-p*1.2)+","+(h+y)+" "+n+","+(h+y)}const o=t.append("polygon");o.attr("points",s(e.x,e.y,50,20,7)),o.attr("class","labelBox"),e.y=e.y+e.labelMargin,e.x=e.x+.5*e.labelMargin,rt(t,e)},Lt=function(t,e,s){const o=t.append("g"),n=nt();n.x=e.x,n.y=e.y,n.fill=e.fill,n.width=s.width*e.taskCount+s.diagramMarginX*(e.taskCount-1),n.height=s.height,n.class="journey-section section-type-"+e.num,n.rx=3,n.ry=3,q(o,n),at(s)(e.text,o,n.x,n.y,n.width,n.height,{class:"journey-section section-type-"+e.num},s,e.colour)};let tt=-1;const Dt=function(t,e,s){const o=e.x+s.width/2,n=t.append("g");tt++;const h=300+5*30;n.append("line").attr("id","task"+tt).attr("x1",o).attr("y1",e.y).attr("x2",o).attr("y2",h).attr("class","task-line").attr("stroke-width","1px").attr("stroke-dasharray","4 2").attr("stroke","#666"),jt(n,{cx:o,cy:300+(5-e.score)*30,score:e.score});const l=nt();l.x=e.x,l.y=e.y,l.fill=e.fill,l.width=s.width,l.height=s.height,l.class="task task-type-"+e.num,l.rx=3,l.ry=3,q(n,l);let y=e.x+14;e.people.forEach(p=>{const m=e.actors[p].color,d={cx:y,cy:e.y,r:7,fill:m,stroke:"#000",title:p,pos:e.actors[p].position};st(n,d),y+=10}),at(s)(e.task,n,l.x,l.y,l.width,l.height,{class:"task"},s,e.colour)},Ft=function(t,e){bt(t,e)},at=function(){function t(n,h,l,y,p,m,d,f){const i=h.append("text").attr("x",l+p/2).attr("y",y+m/2+5).style("font-color",f).style("text-anchor","middle").text(n);o(i,d)}function e(n,h,l,y,p,m,d,f,i){const{taskFontSize:r,taskFontFamily:c}=f,u=n.split(/<br\s*\/?>/gi);for(let a=0;a<u.length;a++){const g=a*r-r*(u.length-1)/2,x=h.append("text").attr("x",l+p/2).attr("y",y).attr("fill",i).style("text-anchor","middle").style("font-size",r).style("font-family",c);x.append("tspan").attr("x",l+p/2).attr("dy",g).text(u[a]),x.attr("y",y+m/2).attr("dominant-baseline","central").attr("alignment-baseline","central"),o(x,d)}}function s(n,h,l,y,p,m,d,f){const i=h.append("switch"),r=i.append("foreignObject").attr("x",l).attr("y",y).attr("width",p).attr("height",m).attr("position","fixed").append("xhtml:div").style("display","table").style("height","100%").style("width","100%");r.append("div").attr("class","label").style("display","table-cell").style("text-align","center").style("vertical-align","middle").text(n),e(n,i,l,y,p,m,d,f),o(r,d)}function o(n,h){for(const l in h)l in h&&n.attr(l,h[l])}return function(n){return n.textPlacement==="fo"?s:n.textPlacement==="old"?t:e}}(),Ot=function(t){t.append("defs").append("marker").attr("id","arrowhead").attr("refX",5).attr("refY",2).attr("markerWidth",6).attr("markerHeight",4).attr("orient","auto").append("path").attr("d","M 0,0 V 4 L6,2 Z")},V={drawRect:q,drawCircle:st,drawSection:Lt,drawText:rt,drawLabel:Vt,drawTask:Dt,drawBackgroundRect:Ft,initGraphics:Ot},Nt=function(t){Object.keys(t).forEach(function(e){O[e]=t[e]})},M={};function Rt(t){const e=P().journey;let s=60;Object.keys(M).forEach(o=>{const n=M[o].color,h={cx:20,cy:s,r:7,fill:n,stroke:"#000",pos:M[o].position};V.drawCircle(t,h);const l={x:40,y:s+7,fill:"#666",text:o,textMargin:e.boxTextMargin|5};V.drawText(t,l),s+=20})}const O=P().journey,I=O.leftMargin,Bt=function(t,e,s,o){const n=P().journey,h=P().securityLevel;let l;h==="sandbox"&&(l=z("#i"+e));const y=h==="sandbox"?z(l.nodes()[0].contentDocument.body):z("body");v.init();const p=y.select("#"+e);V.initGraphics(p);const m=o.db.getTasks(),d=o.db.getDiagramTitle(),f=o.db.getActors();for(const g in M)delete M[g];let i=0;f.forEach(g=>{M[g]={color:n.actorColours[i%n.actorColours.length],position:i},i++}),Rt(p),v.insert(0,0,I,Object.keys(M).length*50),Yt(p,m,0);const r=v.getBounds();d&&p.append("text").text(d).attr("x",I).attr("font-size","4ex").attr("font-weight","bold").attr("y",25);const c=r.stopy-r.starty+2*n.diagramMarginY,u=I+r.stopx+2*n.diagramMarginX;xt(p,c,u,n.useMaxWidth),p.append("line").attr("x1",I).attr("y1",n.height*4).attr("x2",u-I-4).attr("y2",n.height*4).attr("stroke-width",4).attr("stroke","black").attr("marker-end","url(#arrowhead)");const a=d?70:0;p.attr("viewBox",`${r.startx} -25 ${u} ${c+a}`),p.attr("preserveAspectRatio","xMinYMin meet"),p.attr("height",c+a+25)},v={data:{startx:void 0,stopx:void 0,starty:void 0,stopy:void 0},verticalPos:0,sequenceItems:[],init:function(){this.sequenceItems=[],this.data={startx:void 0,stopx:void 0,starty:void 0,stopy:void 0},this.verticalPos=0},updateVal:function(t,e,s,o){t[e]===void 0?t[e]=s:t[e]=o(s,t[e])},updateBounds:function(t,e,s,o){const n=P().journey,h=this;let l=0;function y(p){return function(m){l++;const d=h.sequenceItems.length-l+1;h.updateVal(m,"starty",e-d*n.boxMargin,Math.min),h.updateVal(m,"stopy",o+d*n.boxMargin,Math.max),h.updateVal(v.data,"startx",t-d*n.boxMargin,Math.min),h.updateVal(v.data,"stopx",s+d*n.boxMargin,Math.max),h.updateVal(m,"startx",t-d*n.boxMargin,Math.min),h.updateVal(m,"stopx",s+d*n.boxMargin,Math.max),h.updateVal(v.data,"starty",e-d*n.boxMargin,Math.min),h.updateVal(v.data,"stopy",o+d*n.boxMargin,Math.max)}}this.sequenceItems.forEach(y())},insert:function(t,e,s,o){const n=Math.min(t,s),h=Math.max(t,s),l=Math.min(e,o),y=Math.max(e,o);this.updateVal(v.data,"startx",n,Math.min),this.updateVal(v.data,"starty",l,Math.min),this.updateVal(v.data,"stopx",h,Math.max),this.updateVal(v.data,"stopy",y,Math.max),this.updateBounds(n,l,h,y)},bumpVerticalPos:function(t){this.verticalPos=this.verticalPos+t,this.data.stopy=this.verticalPos},getVerticalPos:function(){return this.verticalPos},getBounds:function(){return this.data}},X=O.sectionFills,et=O.sectionColours,Yt=function(t,e,s){const o=P().journey;let n="";const h=o.height*2+o.diagramMarginY,l=s+h;let y=0,p="#CCC",m="black",d=0;for(const[f,i]of e.entries()){if(n!==i.section){p=X[y%X.length],d=y%X.length,m=et[y%et.length];let c=0;const u=i.section;for(let g=f;g<e.length&&e[g].section==u;g++)c=c+1;const a={x:f*o.taskMargin+f*o.width+I,y:50,text:i.section,fill:p,num:d,colour:m,taskCount:c};V.drawSection(t,a,o),n=i.section,y++}const r=i.people.reduce((c,u)=>(M[u]&&(c[u]=M[u]),c),{});i.x=f*o.taskMargin+f*o.width+I,i.y=l,i.width=o.diagramMarginX,i.height=o.diagramMarginY,i.colour=m,i.fill=p,i.num=d,i.actors=r,V.drawTask(t,i,o),v.insert(i.x,i.y,i.x+i.width+o.taskMargin,300+5*30)}},it={setConf:Nt,draw:Bt},Jt={parser:vt,db:K,renderer:it,styles:At,init:t=>{it.setConf(t.journey),K.clear()}};export{Jt as diagram};
