import{j as t}from"./index-FW1nyG-2.js";import{S as x,d as s,D as g,P as y,M as T,V as j,u as S}from"./useInitAll-CZsFa0QU.js";const E=`
    varying vec2 vUv;
    void main() {
        vUv = uv;
...
`,G=e=>{const{lineWidth:n,height:i,position:m,lineOpenTime:v,scanTime:u,opacityTime:d,renderer:p}=Object.assign({lineWidth:10,height:1e3,width:1e3,position:[0,0,0],lineOpenTime:.8,scanTime:2,opacityTime:.2},e),r=new x({uniforms:{time:{value:0},lineWidth:{value:n/i},lineOpenTime:{value:v},scanTime:{value:u},opacityTime:{value:d},resolution:{value:new s(100,100)},mouse:{value:new s(0,0)}},vertexShader:E,fragmentShader:M,transparent:!0,side:g});var f=new y(100,100,100,100);const c=new T(f,r);c.position.copy(new j(...m));const w=performance.now();p.domElement.addEventListener("mousemove",o=>{const a=o.clientX/window.innerWidth*2-1,h=-(o.clientY/window.innerHeight)*2+1;r.uniforms.mouse.value=new s(a,h)});function l(){const o=performance.now();requestAnimationFrame(l);const a=(o-w)/1e3;r.uniforms.time.value=a}return l(),c},U=()=>{const{sceneRef:e,rendererRef:n}=S("threejs-examples");return React.useEffect(()=>{var i;(i=e.current)==null||i.add(G({renderer:n.current}))},[n,e]),t.jsx(t.Fragment,{children:t.jsx("div",{className:"threejs-examples-main",children:t.jsx("div",{id:"threejs-examples"})})})};export{U as default};
