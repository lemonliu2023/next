import{j as r}from"./index-BytCle9r.js";import{V as d,T as x,S as h,e as y,w as g,c as M,u as j}from"./useInitAll-CuChwT_e.js";const O=`  
  varying vec2 vUv;  
...
`,k=`  
        ...
        `;function w(e={}){const{textureUrl:t,radius:l,renderOrder:u,flipY:c,opacity:m,scrollSpeed:f,position:p}=Object.assign({textureUrl:"/next/honeycomb.png",radius:50,renderOrder:1,flipY:!1,opacity:1,scrollSpeed:.8,position:new d(0,0,0)},e),s=new x().load(t);s.flipY=c;const n=new h({vertexShader:O,fragmentShader:k,uniforms:{tMask:{value:s},uTextureOffset:{value:new y(0,-10)},u_opacity:{value:m}},transparent:!0,depthWrite:!1}),v=new g(l,32,32,0,Math.PI*2,0,Math.PI/2),o=new M(v,n);o.position.copy(p),o.renderOrder=u;const i=()=>{let a=Date.now()*.001*f;a=(a-Math.floor(a))/4,n.uniforms.uTextureOffset.value.y=a,requestAnimationFrame(i)};return i(),o}const _=()=>{const{sceneRef:e}=j("threejs-examples");return React.useEffect(()=>{var t;(t=e.current)==null||t.add(w())},[e]),r.jsx(r.Fragment,{children:r.jsx("div",{className:"threejs-examples-main",children:r.jsx("div",{id:"threejs-examples"})})})};export{_ as default};
